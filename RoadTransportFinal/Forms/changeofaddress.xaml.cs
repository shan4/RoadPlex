...
namespace RoadTransportFinal.Forms
{
    ...
    /// </summary>
    public sealed partial class changeofaddress : Page
    {
        ...
        private async void nextr_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (fname.Text == "" || house.Text == "" ||
                 city.Text == "" || phno.Text == "" || pincode.Text == "" || District.Text == "" || state.SelectedItem.ToString() == "" )
            {
            ...
            else
            {
                ...
                details1.Add("house", house.Text);
                details1.Add("phno", phno.Text);
                ...
                Frame.Navigate(typeof(changeofaddress1), details1);
            }
