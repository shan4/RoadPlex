...
namespace RoadTransportFinal.Savedapp
{
    ...
    /// </summary>
    public sealed partial class RT : Page
    {
        public RT()
        {
        ...
        static string URL = "http://roadtransportdb.azurewebsites.net/roadtax/rtdetails.php";
        static string URL2 = "http://roadtransportdb.azurewebsites.net/roadtax/updatepayment.php";
        static string id;
        ...
        protected async override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            if (details != null)
            {
                appno.Text = details.GetValue("rtno").ToString();
