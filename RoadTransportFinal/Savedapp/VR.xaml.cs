...
namespace RoadTransportFinal.Savedapp
{
    ...
    /// </summary>
    public sealed partial class VR : Page
    {
        static string URL = "http://roadtransportdb.azurewebsites.net/vehicledetails.php";
        static string URL2 = "http://roadtransportdb.azurewebsites.net/updatepayment1.php";
        static string id;
        ...
        protected async override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            if (details != null)
            {
                ...
                {
                    appno.Text = vehicle.appno.ToString();
                    appname.Text = vehicle.fname.ToString();
                    pay.Text = vehicle.payment.ToString();
                    if (vehicle.payment.ToString().Equals("PAID"))
                    {
