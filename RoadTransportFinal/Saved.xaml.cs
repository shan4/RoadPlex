...
namespace RoadTransportFinal.Payement
{
    ...
    public sealed partial class Saved : Page
    {
        ...
        private void pc_Tapped(object sender, TappedRoutedEventArgs e)
        {
            Frame.Navigate(typeof(Savedapp.PC));
        }

        private void vr_Tapped(object sender, TappedRoutedEventArgs e)
        {
            Frame.Navigate(typeof(Savedapp.VR));
        }

        private void rt_Tapped(object sender, TappedRoutedEventArgs e)
        {
            Frame.Navigate(typeof(Savedapp.RT));
        }

        private void dl_Tapped(object sender, TappedRoutedEventArgs e)
        {
            Frame.Navigate(typeof(Savedapp.DL));
        }

        private void receipts_Click(object sender, RoutedEventArgs e)
        {
            Frame.Navigate(typeof(Savedapp.Receipts.Show));
        }
    }
}
