...
namespace RoadTransportFinal.Savedapp.Receipts
{
    ...
    /// </summary>
    public sealed partial class ShowEach : Page
    {
        public ShowEach()
        {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            fullname.Text = "Receipt For :" + vehicle.name.ToString();
            appdate.Text = "Receipt Number :" + vehicle.rno.ToString();
            appno.Text = "Application Number :" + vehicle.appno.ToString();
            dealer.Text = "Paid Date : " + vehicle.pdate.ToString();
