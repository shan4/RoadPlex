...
namespace RoadTransportFinal.Savedapp
{
    ...
    /// </summary>
    public sealed partial class DL : Page
    {
        static string URL = "http://roadtransportdb.azurewebsites.net/dldetails.php";
        static string URL2 = "http://roadtransportdb.azurewebsites.net/updatepayment.php";
        static string id;
        ...
        protected async override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            if (details != null)
            {
                appno.Text = details.GetValue("appno").ToString();
                appname.Text = details.GetValue("appfor").ToString();
        ...
        private async void button1_Click(object sender, RoutedEventArgs e)
        {
            if(details != null)
            {
                    ...
                    pairs.Add("id", id);
                    pairs.Add("appno", details.GetValue("appno").ToString());
